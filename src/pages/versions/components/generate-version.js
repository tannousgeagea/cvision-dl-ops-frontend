...
const GenerateVersionSection = ({ projectId }) => {
    const { data: datasetInfo, loading: datasetLoading, error: datasetError } = useFetchData(
        `/api/v1/projects/${projectId}/dataset-info`
    );
